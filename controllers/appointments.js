...
const { findById, findByIdAndUpdate } = require('../models/Hospital');
const Hospital = require('../models/Hospital');

//@desc     Get all appointmenrs
...
exports.updateAppointment = async (req,res,next) =>{
    try{
        ...
        if(!appointment){
            return res.status(404).json({success:false,message:`No appt with id of ${req.params.id}`});
        }
